                    ...
                    for gtm_lr in gtm_lr_list:
                        for drop_prob in drop_prob_list:
                            for gtm_rbf in gtm_rbf_list:
                                for gtm_sigma in gtm_sigma_list:
                                    ...
                                    if sys.platform == 'win32':
                                        ...
                                        training_log_dir = os.path.join(os.getcwd(), "Thesis_GTM/experiments/TORUN",
                                                                        test_name)
                                    ...
                                    for split_id, split in enumerate(dataset_cv_splits):
                                        ...
                                        model = GNN_Conv_GTM(loader_train.dataset.num_features, n_units, n_classes,
                                                             gtm_grids_dim, gtm_rbf, gtm_sigma, gtm_lr,
                                        ...
                                        model_impl.train_test_model(split_id=split_id, loader_train=loader_train,
